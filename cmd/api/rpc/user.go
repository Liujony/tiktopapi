...
import (
	...
	"github.com/Liujony/tiktokapi/kitex_gen/user"
	"github.com/Liujony/tiktokapi/kitex_gen/user/userservice"
...
func init() {
	...
	c, err := userservice.NewClient("User", client.WithHostPorts("127.0.0.1:8088"))
	if err != nil {
		panic(err)
	}
	userClient = c
